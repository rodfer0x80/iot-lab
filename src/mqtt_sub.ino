...
#define MEASUREMENT_TIMEINTERVAL 5 // Seconds
...
const char* wifi_ssid = "GL-AR750-G4";
const char* wifi_password = "IOT-LABG4";
...
void reconnect() {
    ...
    while (!client.connected()) {
        ...
        if (client.connect("ESP8266Client")) {                                //anonymous user
//        if (client.connect("ESP8266Client", mqtt_user, mqtt_password)) {    //authenticated user
...
//  {"temperature": 21.00, "humidity": 30.00}
